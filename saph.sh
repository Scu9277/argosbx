...
sapsbxinstall(){
URL="https://raw.githubusercontent.com/Scu9277/argosbx/main/sapsbxh.sh"
...
command -v curl > /dev/null 2>&1 && bash <(curl -Ls https://raw.githubusercontent.com/Scu9277/argosbx/main/saph.sh) || bash <(wget -qO- https://raw.githubusercontent.com/Scu9277/argosbx/main/saph.sh)
else
