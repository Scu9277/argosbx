...
sapsbxinstall(){
URL="https://raw.githubusercontent.com/Scu9277/argosbx/main/sapsbx.sh"
DEST="$HOME/sapsbx.sh"
...
command -v curl > /dev/null 2>&1 && bash <(curl -Ls https://raw.githubusercontent.com/Scu9277/argosbx/main/sap.sh) || bash <(wget -qO- https://raw.githubusercontent.com/Scu9277/argosbx/main/sap.sh)
else
